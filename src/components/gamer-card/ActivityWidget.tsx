      ...
      <div className="relative z-20 h-full flex flex-col justify-between">
        ...
        <header className="flex justify-between items-start mb-4">
          <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center text-xl md:text-2xl shadow-lg text-white/90">
            {activity?.type === 0 ? <LuGamepad2 /> : <LuCode />}
          </div>
          ...
          {activity && (
            <div className="flex flex-col items-end">
              ...
              {activity.timestamps?.start && (
                <time className="text-[10px] text-gray-300 font-mono mt-0.5 bg-black/50 px-1.5 py-0.5 rounded">
        ...
        <div className="mt-2 flex items-center gap-4">
          {/* Game Art Badge */}
          <figure className="relative w-16 h-16 md:w-20 md:h-20 shrink-0">
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              {detailedState.icon}
              <p className="text-xs md:text-sm lg:text-base italic line-clamp-1 font-medium">
                {detailedState.label}
              </p>
            </div>
          </div>
