...
export const SpotifyWidget = ({ spotify, currentTime }: SpotifyWidgetProps) => {
  return (
    <div className="w-full bg-[#12131a] rounded-[1.5rem]  border border-white/5 overflow-hidden relative group mb-6 md:mb-8 shadow-2xl min-h-[250px] flex items-center justify-center">
      ...
      {spotify ? (
        ...
        /* IDLE STATE (No Music) */
        <div className="p-8 relative z-10 text-center opacity-60">
